...
## Bug Reports
The LBSPR package is still in development. It is possible, even highly likely, that there are bugs and issues with some of the functions. Please alert me to any bugs or issues that you come across (either email or GitHub).
