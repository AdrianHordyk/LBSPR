...
#' @slot MK A length-one numeric vector
#' @slot Linf A length-one numeric vector
#' @slot CVLinf A length-one numeric vector
#' @slot L50 A length-one numeric vector
#' @slot L95 A length-one numeric vector
#' @slot Walpha A length-one numeric vector
#' @slot Wbeta A length-one numeric vector
#' @slot FecB A length-one numeric vector
#' @slot Steepness A length-one numeric vector
#' @slot Mpow A length-one numeric vector
#' @slot R0 A length-one numeric vector
#' @slot SL50 A length-one numeric vector
#' @slot SL95 A length-one numeric vector
#' @slot FM A length-one numeric vector
#' @slot SPR A length-one numeric vector
#' @slot BinMin A length-one numeric vector
#' @slot BinMax A length-one numeric vector
#' @slot BinWidth A length-one numeric vector
#' @export
...
#'
#' @slot LMids Character vector of species name
#' @slot LData A length-one numeric vector
#' @slot Years Character vector of species name
#' @slot NYears A length-one numeric vector
#' @slot Elog A length-one numeric vector
#' @export
...
#' @slot SPR Character vector of species name
#' @slot Yield A length-one numeric vector
#' @slot LMids Character vector of species name
#' @slot pLCatch A length-one numeric vector
#' @slot pLPop A length-one numeric vector
#' @slot Ests A length-one numeric vector
#' @slot NLL A length-one numeric vector
#' @slot maxFM A length-one numeric vector
#' @export
